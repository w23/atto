...
typedef enum {
	...
	AK_Esc = 27, AK_PageUp = 33, AK_PageDown = 34, AK_Left = 37, AK_Up = 38,
	AK_Right = 39, AK_Down = 40,
	AK_Asterisk = '*', AK_Plus = '+', AK_Comma = ',', AK_Minus = '-', AK_Dot = '.',
	AK_Slash = '/', AK_0 = '0', AK_1 = '1', AK_2 = '2', AK_3 = '3', AK_4 = '4',
	AK_5 = '5', AK_6 = '6', AK_7 = '7', AK_8 = '8', AK_9 = '9', AK_Equal = '=',
	AK_A = 'a', AK_B = 'b', AK_C = 'c', AK_D = 'd', AK_E = 'e', AK_F = 'f', AK_G = 'g',
	AK_H = 'h', AK_I = 'i', AK_J = 'j', AK_K = 'k', AK_L = 'l', AK_M = 'm', AK_N = 'n',
	AK_O = 'o', AK_P = 'p', AK_Q = 'q', AK_R = 'r', AK_S = 's', AK_T = 't', AK_U = 'u',
	AK_V = 'v', AK_W = 'w', AK_X = 'x', AK_Y = 'y', AK_Z = 'z', AK_Tilda = '~',
	AK_Del = 127, AK_Ins, AK_LeftAlt, AK_LeftCtrl, AK_LeftMeta, AK_LeftSuper,
	AK_LeftShift, AK_RightAlt, AK_RightCtrl, AK_RightMeta, AK_RightSuper, AK_RightShift,
	AK_F1, AK_F2, AK_F3, AK_F4, AK_F5, AK_F6, AK_F7, AK_F8, AK_F9, AK_F10, AK_F11, AK_F12,
	AK_KeypadAsterisk, AK_KeypadPlus, AK_KeypadMinus, AK_Home, AK_End, AK_Capslock,
	AK_Max = 256
} AKey;
